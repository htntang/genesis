...
const pages = ['Scholarship Database', 'Coaching', 'Blog', 'About', 'Meet the Team'];
                    ...
                    <Toolbar disableGutters>
                        ...
                        <IconButton
                            ...
                            <Menu
                                ...
                                sx={{
                                    display: { xs: 'block', md: 'none', color: '#eee' },
                                }}
                                >
                                    {pages.map((page) => (
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                            ...
                            <Button
                                ...
                                sx={{ my: 2, color: '#eee', display: 'block' }}
                            >
                                {page}
                            </Button>
                            ))}
